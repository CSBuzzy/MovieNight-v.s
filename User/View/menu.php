...
<body>
	<div id="divMenu">
		<div id="menu">
		 	...
		 	<a class="icons" href="/MovieNight-v.s/User/public/img/image.png" id="icon2"><i id="image2" class="fa fa-rocket images"></i></a>
		 	<a class="icons" id="icon3" href="../Controller/profil.php"><i id="image3" class="fa fa-user images"></i></a>
